...
const PricingModal = ({ isOpen, onClose }: PricingModalProps) => {
  ...
  const pricingData = [
    ...
    },
    {
      ...
      gallery: ["/rooms/nipa1.webp", "/rooms/nipa2.webp", "/rooms/nipa3.webp"],
    },
    {
      id: 4,
      type: "Camping Tent",
    ...
    },
    {
      ...
      gallery: ["/rooms/cot.webp", "/rooms/cot2.webp"],
    },
    {
      id: 6,
      type: "Gazebo",
      ...
      gallery: ["/rooms/gazebo.webp", "/rooms/gazebo2.webp"],
    },
    {
      id: 7,
      type: "Picnic Table",
    ...
    },
    {
      ...
      gallery: ["/rooms/tablenchair.webp"],
    },
  ];
