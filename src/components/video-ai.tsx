  ...
  return (
    <>
      <button
        ...
        className="bg-linear-to-br from-orange-700 to-violet-500 text-white px-4 py-2 rounded-full flex items-center justify-center mx-auto mt-8 cursor-pointer shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300"
      >
        Ai assistant
      </button>
      {show && (
