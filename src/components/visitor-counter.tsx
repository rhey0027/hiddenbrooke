...
import useVisitorCounter from "./use-visitor-counter";

export default function VisitorCounter() {
  const { count, loading, error } = useVisitorCounter();

  return (
    <div className="gap-3 px-5 py-1 inline-flex items-center rounded-full bg-black/50 backdrop-blur-sm shadow-lg">
      {/* Live pulsing dot */}
...
//   return (
//     <div className="absolute left-20 top-13 transform -translate-x-1/2 flex items-center gap-2 bg-black/50 max-w-38 rounded-full px-6 py-1 shadow-md text-sm text-stone-600">
